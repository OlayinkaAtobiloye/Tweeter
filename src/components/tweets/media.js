...
class Media extends React.Component {
  ...
  componentDidMount() {
    ...
    let url = `https://tweeter-test-yin.herokuapp.com/user/${userId}/media`;
    axios({
      method: "get",
      url: url,
      headers: {
      ...
      <section>
        ...
        {!this.state.loading &&
          ...
          this.state.tweets.length === 0 && (
            <p style={{ display: "flex", justifyContent: "center" }}>
              This user doesn't have any post with media yet.
            </p>
          )}
      </section>
    );
...
export default connect(mapStateToProps, null)(withHooksHOC(Media));
